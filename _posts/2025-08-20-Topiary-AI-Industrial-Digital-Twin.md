...
tags: [Python, FastAPI, React, Machine Learning, Digital Twin, LLM, OCP, "1337", Docker, scikit-learn, Optimization]
...
Here is the complete Topiary dashboard interface showing all components integrated into a unified control room view:

![Topiary Operator Interface](/assets/img/posts/Topiary/5.png)
_Topiary Operator Interface: A unified dashboard featuring a control panel, real-time KPI metrics, interactive process flow diagram, and a local AI Assistant._
...
The operator adjusts these inputs via the control sidebar:

![Topiary Control Sidebar](/assets/img/posts/Topiary/3.png)
_Topiary Control Sidebar: Sliders allowing operators to adjust sulfur feed and steam admission to the three Turbo-Alternator Groups (GTAs) in real-time._
...
Here is the predicted plant layout and process flow diagram generated by the Digital Twin model:

![Process Flow Mimic](/assets/img/posts/Topiary/2.png)
_Process Flow Mimic: A digital twin visualization representing predicted power outputs and steam rates across all turbines and steam collectors._

The key performance indicators (KPIs) at the top of the interface are updated instantly based on these predictions:

![KPI Header](/assets/img/posts/Topiary/7.png)
_KPI Header: Key performance indicators computed dynamically from digital twin predictions._
...
The optimizer outputs setpoint suggestions directly to the operator interface:

![Optimization Suggestion](/assets/img/posts/Topiary/1.png)
_Optimization Suggestion: The Random Search solver recommends optimal setpoints to maximize generation while respecting steam availability constraints._
...
In addition to plant mimic telemetry, the operator can monitor apparent power metrics:

![Grid Apparent Power](/assets/img/posts/Topiary/4.png)
_Grid Apparent Power: Telemetry monitoring the apparent power of the grid transformers._
...
Active alerts are displayed clearly in the assistant panel of the dashboard:

![Active Alerts](/assets/img/posts/Topiary/6.png)
_Active Alerts: The system instantly flags anomalous or impossible scenarios, such as when steam extraction exceeds generated steam or when turbine consumption is too high._
